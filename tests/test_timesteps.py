...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Upper bound for the timestep scheduler.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=800,
        help="Lower bound for the timestep scheduler.",
    )
...
def main(args):
    ...
    run_name = str(args.lower_bound) + "_" + str(args.upper_bound)
    project_name=args.dataset + "_timesteps_analysis"
    ...
    train_config=TrainConfig(
        ...
        use_timestep_scheduler=True,
        timestep_scheduler_fixed_bounds=[args.upper_bound, args.lower_bound],
    )
